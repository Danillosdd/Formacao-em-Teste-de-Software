...
// Classe de teste automatizado para compra de passagem
public class ComprarPassagemTest {
  ...
  // Teste principal: fluxo de compra de passagem
  @Test
  public void comprarPassagem() {
    ...
    // Realiza algumas ações com o mouse no campo de destino (pode ser removido se não necessário)
    {
    ...
    // Clica em elementos da página para avançar no fluxo
